...
public class Maze {
    ...
    static ArrayList<String> mazeList(String p,int r,int c){
        ...
        ArrayList<String> list = new ArrayList<>();
        if(r > 1){
            list.addAll(mazeList(p+'D',r-1,c));
        }
        if(c > 1){
            list.addAll(mazeList(p+'R',r,c-1));
        }
        return list;
    }
    ...
    static ArrayList<String> mazeListDiagonal(String p,int r,int c){
        ...
        ArrayList<String> list = new ArrayList<>();
        if(r>1 && c>1){
            list.addAll(mazeListDiagonal(p+'D',r-1,c-1));
        }
        if(r > 1){
            list.addAll(mazeListDiagonal(p+'V',r-1,c));
        }
        if(c > 1){
            list.addAll(mazeListDiagonal(p+'R',r,c-1));
        }
        return list;
    }
